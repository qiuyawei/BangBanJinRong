package com.ipd.bangbanjinrong.reciver;
...
//                processCustomMessage(context, bundle);
            ...
            Intent intent1=new Intent(context, Meassage.class);
            intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            context.startActivity(intent1);
            /*SpUtil.getInstance(context).putString("POSITION","");
            Intent i = new Intent();
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            if(bundle.toString().contains("系统已确认您的预约")){
                i.setClass(context, MainActivity.class);
                SpUtil.getInstance(context).putString("POSITION","1");
            }
            if(bundle.toString().contains("您有一份合同等待确认")){
                //合同
                i.setClass(context, HeTongActivity.class);
            }
