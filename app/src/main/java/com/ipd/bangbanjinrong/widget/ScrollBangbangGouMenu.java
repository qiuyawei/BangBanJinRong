...
public class ScrollBangbangGouMenu extends LinearLayout {
    ...
    public void setMenu(List<String> titleList, final onMenuClickListener onMenuClickListener,int posss) {
        int pos = 0;
        ...
        View curView = this.getChildAt(posss);
    ...
    public void setChecked(boolean isChecked, LinearLayout titleMenu) {
        ((TextView) (titleMenu.findViewById(R.id.tv_title))).setTextColor(isChecked ? getResources().getColor(R.color.base_color) :
