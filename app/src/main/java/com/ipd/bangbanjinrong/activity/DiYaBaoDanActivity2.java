...
public class DiYaBaoDanActivity2 extends BaseActivity {
    ...
    private void showHead() {
        new MySelfSheetDialog(context).builder().addSheetItem("拍照", MySelfSheetDialog.SheetItemColor.Blue, new MySelfSheetDialog.OnSheetItemClickListener() {
            ...
            public void onClick(int which) {
                if (CommonUtil.checkPersiomion(DiYaBaoDanActivity2.this, Manifest.permission.CAMERA)) {
            ...
            public void onClick(int which) {
//                加上读取权限
                if (CommonUtil.checkPersiomion(DiYaBaoDanActivity2.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (json.getString("response").equals("0")) {
                        ...
                        intent = new Intent(DiYaBaoDanActivity2.this, DiYaBaoDanActivity3.class);
