...
public class BandPhoneActivity extends BaseActivity{
    ...
    private String phone,password,vercode,openId,type;
    ...
    public int setLayout() {
        return R.layout.bind_phone_activty;
    }

    @Override
    public void innitData() {
        setBack();
        setTopTitle(getResources().getString(R.string.band_phone));
...
//                获取验证码
    ...
    private void getCheckCode(){
        ...
        RequestParams params=new RequestParams(Constant.SEVER_API+"app_user/bindCode.do");
    ...
    private void resgisterServer(){
        ...
        dialog();
        String[]keys={"PHONE","PASSWORD","OPENID","TYPE","RESULT"};
        String[]values={phone,password,openId,type,vercode};
        RequestParams params=new RequestParams(Constant.SEVER_API+"app_user/bind.do");
