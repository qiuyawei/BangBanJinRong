...
public class GuoQiaoDianZi3 extends BaseActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_right:
                ...
                break;
            case R.id.ivImage:
                PhotoPreviewIntent intent = new PhotoPreviewIntent(GuoQiaoDianZi3.this);
    ...
    private void submitData(){
        ...
        dialog();
        String[] keys={"TRUENAME","APPUSER_ID","NUMBERID","REQUEST_MONEY","HOUSE_WORTH","REQUEST_TIME","PIC_NO","PIC_HOME","PIC_EXTRA","FACE_CERT","BACK_CERT","HOUSE_NO"};
        String[] values=content.split(";");
        Log.i("TAG","length="+values.length);

        String json= JsonUtil.getJsonString(keys,values);
        LogUtils.print("json",json);
        RequestParams params=new RequestParams(Constant.SEVER_API+"app_order/addg.do");
