...
public class CityChoice extends BaseActivity{
    ...
    public void innitData() {
        setBack();
        setTopTitle(getResources().getString(R.string.csxx));
    }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.bt_sure){
            region=et_city.getText().toString().trim();
