package com.jumpbox.jumpboxlibrary.pulltorefresh;
...
import com.jumpbox.jumpboxlibrary.pulltorefresh.ILoadingLayout.State;
...
//        设置点击背景颜色
    ...
    public void setDividercolor(int dividercolor) {
        ...
        if(mListView!=null){
            mListView.setDivider(getResources().getDrawable(dividercolor));
        }
    }
    ...
    public void
    setMyDividerHeight(int dividerHeight) {
        if(mListView!=null){
